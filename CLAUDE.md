...
- `GRAPH_RECURSION_LIMIT` (optional, default: `40`) — max LangGraph agent↔tool loop iterations before stopping. 40 = 20 round-trips. Prevents runaway tool-call loops.
