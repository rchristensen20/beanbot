...
class CalendarTaskView(discord.ui.View):
    ...
    async def _update_calendar_tasks(self, interaction: discord.Interaction):
        ...
        prompt = (
            ...
            "Your job:\n"
            "1. Read these files using tool_read_files to review the ingested content.\n"
            ...
            "soil amendment) using tool_search_knowledge and note useful cross-references.\n"
            ...
            "   - Do NOT create tasks for dates that have already passed (today's date is in the system prompt).\n"
    ...
    async def _consolidate_single(self, ctx, topic: str):
        ...
        async with ctx.channel.typing():
            ...
            prompt = (
                ...
                f"Your job:\n"
                f"1. Read ALL of these files using tool_read_files.\n"
                f"2. Analyze the content. Identify which files are primarily ABOUT '{topic}' vs files that merely mention it.\n"
                f"3. For files primarily about '{topic}': merge all unique facts into a single clean '{topic}.md' using tool_overwrite_file.\n"
                ...
                f"4. Delete sub-files that were fully merged into '{topic}.md' using tool_delete_file (auto-backs up). Do NOT delete '{topic}.md' itself.\n"
                f"5. Leave files that merely MENTION '{topic}' alone — do not modify or delete them.\n"
                f"6. Reply with a summary of what was consolidated, merged, and deleted."
            )
